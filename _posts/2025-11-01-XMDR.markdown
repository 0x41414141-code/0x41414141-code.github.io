...
   # Chrome locks the history file, so we need to copy it  
   import shutil  
...
               if extracted_content:  # Only print if there's actual content  
                   print("\n")  
